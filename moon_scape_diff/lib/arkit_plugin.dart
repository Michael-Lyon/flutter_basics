...
class ARKitPlugin {
  ...
  static Future<bool> checkConfiguration(
      ARKitConfiguration configuration) async {
    final bool? result =
        await _channel.invokeMethod<bool>('checkConfiguration', {
      'configuration': configuration.index,
    });
    return result ??
        false; // Handle the null case by returning false or another default value
  }
}
