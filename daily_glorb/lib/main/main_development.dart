...
import 'package:daily_glorb/main/bootstrap/bootstrap.dart';
import 'package:daily_glorb/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'Daily Glorb [DEV]',
        packageName: 'com.daily.glorb.dev',
