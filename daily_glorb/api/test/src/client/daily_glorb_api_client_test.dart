...
void main() {
  ...
  group('DailyGlorbApiClient', () {
    late http.Client httpClient;
    late DailyGlorbApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = DailyGlorbApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => DailyGlorbApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = DailyGlorbApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws DailyGlorbApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<DailyGlorbApiMalformedResponse>()),
        );
      });

      test(
          'throws DailyGlorbApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<DailyGlorbApiRequestFailure>()
