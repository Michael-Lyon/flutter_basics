...
import 'package:daily_glorb_api/client.dart';
import 'package:http/http.dart' as http;

/// {@template daily_glorb_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class DailyGlorbApiMalformedResponse implements Exception {
  /// {@macro daily_glorb_api_malformed_response}
  const DailyGlorbApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template daily_glorb_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class DailyGlorbApiRequestFailure implements Exception {
  /// {@macro daily_glorb_api_request_failure}
  const DailyGlorbApiRequestFailure({
...
/// {@template daily_glorb_api_client}
/// A Dart API client for the Daily Glorb API.
/// {@endtemplate}
class DailyGlorbApiClient {
  /// Create an instance of [DailyGlorbApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro daily_glorb_api_client}
  DailyGlorbApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw DailyGlorbApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        DailyGlorbApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
